...
- Q5 Geometry/Routing: overlap, margin, gap, and available route checks pass against centralized thresholds.
- Q6 Rendered Visual QA: a clean width-capped preview is reviewed when the native CLI is available.
