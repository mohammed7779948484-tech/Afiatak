# Activity Diagram — Review Facility Onboarding Request
## Aafiatak Medical Appointment Booking System — MVP Activity Diagram Specification

**Diagram ID:** `AD-15`  
**Deliverable:** UML Activity Diagram  
**Use Case:** `Review Facility Onboarding Request`  
**Traceability:** UCM-15; MUC-27/PAUC-03; Project Specification §§8.3, 10.6  
...
### Separation
Review does not silently collapse Request Additional Information, Approve, Reject, Activate, or initial Facility Administrator provisioning into one hidden action.

### Reopen/retry
If review is reopened later, prior review history is displayed and new permitted assessment is appended/preserved rather than silently overwritten.

### No applicant actor
Current MVP has no public FacilityApplicant self-service portal/actor.
...
- Pass 2: UCM-15 success
- Pass 3: information sufficiency
- Pass 4: request additional info
- Pass 5: approval next action
- Pass 6: rejection next action
- Pass 7: separation of use cases
- Pass 8: review history
- Pass 9: no FacilityApplicant
- Pass 10: platform boundary
- Pass 11: Decision/Merge
- Pass 12: no Fork/Join
- Pass 13: no implementation internals
- Pass 14: visual simplicity
