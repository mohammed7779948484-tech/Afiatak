...
from engine.compositions import aafiatak_booking_reception_staff_part_1 as composition
from engine.svg.booking_reception_staff_use_case import render_booking_reception_staff_svg

def render_booking_reception_staff_part_1_svg(model: SemanticModel, view: ViewSpec, output: Path) -> Path:
