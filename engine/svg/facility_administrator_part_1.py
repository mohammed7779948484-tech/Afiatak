...
from engine.compositions import aafiatak_facility_administrator_part_1 as composition
...
def render_facility_administrator_part_1_svg(model: SemanticModel, view: ViewSpec, output: Path) -> Path:
