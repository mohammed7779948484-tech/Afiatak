...
def export_collaboration_drawio(model, view, output: Path) -> None:
    ...
    for link in plan.links.values():
        polyline_edge(cells, next_id(f"link-{link.link_id}"), link.polyline.points, "html=1;endArrow=none;startArrow=none;strokeColor=#878787;strokeWidth=1.3;rounded=0;")
